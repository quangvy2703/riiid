...
#
## NPA
#python main.py --num_workers=8 --gpu=0 --device=cuda --model=DKT --num_epochs=6 --attention_dim=100 --fc_dim=200
#--eval_steps=5000 --train_batch=2048 --test_batch=2048 --seq_size=200
#--input_dim=100 --hidden_dim=100 --name=EdNet-KT1_NPA_dim_100_100
#--dataset_name=EdNet-KT1 --cross_validation=1
#
## SAKT
